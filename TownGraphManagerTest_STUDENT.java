...
public class TownGraphManagerTest_STUDENT {
	...
	public void setUp() throws Exception {
		...
		graph.addRoad(town[1], town[2], 15, "Road_1");
		graph.addRoad(town[1], town[3], 4, "Road_2");
		graph.addRoad(town[3], town[7], 3, "Road_4");
		graph.addRoad(town[3], town[8], 4, "Road_5");
		graph.addRoad(town[4], town[8], 2, "Road_6");
		graph.addRoad(town[6], town[9], 3, "Road_7");
		graph.addRoad(town[9], town[10], 7, "Road_8");
		graph.addRoad(town[8], town[10], 2, "Road_9");
		graph.addRoad(town[5], town[10], 8, "Road_10");
	...
	public void testAddRoad() {
		...
		assertEquals("Road_1", roads.get(0));
		assertEquals("Road_10", roads.get(1));
		assertEquals("Road_13", roads.get(2));
	...
	public void testContainsRoadConnection() {
		assertEquals(true, graph.containsRoadConnection(town[5], town[10]));
	...
	public void testDeleteRoadConnection() {
		assertEquals(true, graph.containsRoadConnection(town[5], town[10]));
		graph.deleteRoadConnection(town[5], town[10], "Road_10");
		assertEquals(false, graph.containsRoadConnection(town[5], town[10]));
	}
	...
	public void testGetPath() {
		ArrayList<String> path = graph.getPath(town[5], town[10]);
		assertNotNull(path);
		assertTrue(path.size() > 0);
		assertEquals("Town_5 via Road_10 to Town_10 8 mi", path.get(0).trim());
	...
	public void testGetPathA() {
		...
		assertEquals("Town_3 via Road_5 to Town_8 4 mi", path.get(1).trim());
	...
	public void testGetPathB() {
		...
		assertEquals("Town_3 via Road_5 to Town_8 4 mi", path.get(1).trim());
		assertEquals("Town_8 via Road_9 to Town_10 2 mi", path.get(2).trim());
		assertEquals("Town_10 via Road_8 to Town_9 7 mi", path.get(3).trim());
