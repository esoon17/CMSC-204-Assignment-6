...
public class GraphTest_STUDENT {
	...
	public void testGetEdge() {
		assertEquals(new Road(town[5], town[10], 6, "Road_12"), graph.getEdge(town[5], town[10]));
	...
	public void testRemoveEdge() {
		assertEquals(true, graph.containsEdge(town[5], town[10]));
		graph.removeEdge(town[5], town[10], 8, "Road_10");
		assertEquals(false, graph.containsEdge(town[5], town[10]));
	}
	...
	public void testTown_4ToTown_10() {
		...
		if (beginIndex != null && endIndex != null) {
			...
			assertNotNull(path);
			assertTrue(path.size() > 0);
			assertEquals("Town_4 via Road_6 to Town_8 2 mi", path.get(0).trim());
